...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 20px;padding: 140px;height: 300px;">
		<div class="row">
			<div class="alert alert-success"> User Successsfully logged in</div>
		</div>
	</div>
	<a href="../../restaurant/viewRestaurant"><button class="btn btn-primary" style="margin-left: 10%; margin-bottom: 2%;">Start ordering</button></a>
