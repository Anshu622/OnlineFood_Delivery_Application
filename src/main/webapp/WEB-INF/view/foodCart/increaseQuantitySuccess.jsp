...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 20px;padding: 140px;height: 300px;">
		<div class="row">
			<div class="alert alert-success">Item successfully increased</div>
		  </div>

          <form:form action="/item/viewitem" method="get" modelAttribute="quantity">
    ...
    <form:form action="/orderdetails/vieworder" method="get" modelAttribute="quantity">
