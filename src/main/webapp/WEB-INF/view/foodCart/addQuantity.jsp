<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*,org.FoodDelivery.Model.Restaurant,org.FoodDelivery.Model.FoodCart,org.FoodDelivery.Model.Item"%>
...
<body>
	...
	out.print("<p><a class=\"btn btn-primary\" style:\"margin-left:10%; \" href=\"http://localhost:5002/item/listitem?restaurantId=" +restaurant.getRestaurantId()+ "\">Add More</a></p>");
	%>
