...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 240px;padding: 150px;height: 300px;">
		<div class="row">
			<form:form action="/item/modifyitemprocess" method="post" modelAttribute="item">

               <form:hidden path = "itemId" value = "${item.itemId}" />
	  
			  <div class="form-group">
				<label for="itemName">ItemName</label>
				<form:input path="itemName" value="${item.itemName}" class="form-control" id="itemName"/>
			  </div>

			  <div class="form-group">
				<label for="quantity">Quantity</label>
				<form:input path="quantity" value="${item.quantity}" class="form-control" id="quantity"/>
			  </div>

			  <div class="form-group">
				<label for="cost">Cost</label>
				<form:input path="cost" value="${item.cost}" class="form-control" id="cost"/>
			  </div>
