...
<body>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="item/listitems">View Item</a>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 240px;padding: 150px;height: 300px;">
		<div class="row">
			<form:form action="/item/deleteitemprocess" method="post" modelAttribute="item">

               <form:hidden path = "itemId" value = "${item.itemId}" />
	  
			  <div class="form-group">
				<label for="itemName">ItemName</label>
				<input type="text" disabled value="${item.itemName}" class="form-control" id="itemName"/>
			  </div>

			  <div class="form-group">
				<label for="quantity">Quantity</label>
				<input type="text" disabled value="${item.quantity}" class="form-control" id="quantity"/>
			  </div>

			  <div class="form-group">
				<label for="cost">Cost</label>
				<input type="text" disabled value="${item.cost}" class="form-control" id="cost"/>
			  </div>
