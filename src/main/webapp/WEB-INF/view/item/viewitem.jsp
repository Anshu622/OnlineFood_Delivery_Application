...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 330px;padding: 120px;height: 300px;">
        <div class="row">
          <form:form action="/item/listitem" method="get" modelAttribute="item">
            
            <div class="form-group">
                <label for="itemId">Item ID</label>
                <input type="text" disabled value="${item.itemId}" class="form-control" id="itemId"/>
            </div>
            <div class="form-group">
