...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 380px;padding: 120px;height: 300px;">
		<div class="row">

			<form:form action="/item/additem" method="post" modelAttribute="item">

				<form:hidden path = "restaurant.restaurantId" value = "${restaurant.restaurantId}" />
				<form:hidden path = "restaurant.restaurantName" value = "${restaurant.restaurantName}" />
				<form:hidden path = "restaurant.managerName" value = "${restaurant.managerName}" />
				<form:hidden path = "restaurant.contactNumber" value = "${restaurant.contactNumber}" />
				<form:hidden path = "restaurant.imageName" value = "${restaurant.imageName}" />
