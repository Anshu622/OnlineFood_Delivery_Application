        ...
        <table class="table table-striped table-inverse table-responsive">
          ...
          <tbody>
            <%
              ...
              for(Item item : items){
                out.println("<tr>");
                out.println("<td scope=\"row\">"+item.getItemId()+"</td>");
                out.println("<td scope=\"row\">"+item.getItemName()+"</td>");
                out.println("<td><a href=\"http://localhost:5000/item/viewitem?itemid=" +item.getItemId() +"\"><button>View</button></a></td>");
                out.println("<td><a href=\"http://localhost:5000/item/fetchdeleteitem?itemid=" +item.getItemId() +"\"><button>Delete Item</button></a></td>");
                out.println("</tr>");
              }
            %>  
          </tbody>
