		...
		<div class="row">
			<form:form action="/restaurant/deleterestaurantprocess" method="post" modelAttribute="restaurant">
			  ...
			  <div class="form-group">
				...
				<input type="text" disabled value="${restaurant.restaurantName}" class="form-control" id="restaurantName"/>
			  </div>

			  <div class="form-group">
				<label for="managerName">ManagerName</label>
				<input type="text" disabled value="${restaurant.managerName}" class="form-control" id="managerName"/>
			  </div>

			  <div class="form-group">
				<label for="contactNumber">ContactNumber</label>
				<input type="text" disabled value="${restaurant.contactNumber}" class="form-control" id="contactNumber"/>
			  </div>
