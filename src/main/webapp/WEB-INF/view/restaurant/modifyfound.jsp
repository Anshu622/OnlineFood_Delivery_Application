	...
	<div class="container" style="margin-top: 0px;margin-bottom: 240px;padding: 150px;height: 300px;">
		<div class="row">
			<form:form action="/restaurant/modifyrestaurantprocess" method="post" modelAttribute="restaurant">
			   ...
			   <form:hidden path = "imageName" value = "${restaurant.imageName}" />
	  
			  <div class="form-group">
				<label for="restaurantName">RestaurantName</label>
				<form:input path="restaurantName" value="${restaurant.restaurantName}" class="form-control" id="restaurantName"/>
			  </div>

			  <div class="form-group">
				<label for="managerName">ManagerName</label>
				<form:input path="managerName" value="${restaurant.managerName}" class="form-control" id="managerName"/>
			  </div>

			  <div class="form-group">
				<label for="contactNumber">ContactNumber</label>
				<form:input path="contactNumber" value="${restaurant.contactNumber}" class="form-control" id="contactNumber"/>
			  </div>
