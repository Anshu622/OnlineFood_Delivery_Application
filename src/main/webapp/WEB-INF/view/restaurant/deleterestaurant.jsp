...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 70px;padding: 140px;height: 300px;">
		<div class="row">
			<form:form action="/restaurant/fetchfordeleterestaurant" method="get" modelAttribute="restaurant">
			  ...
			  <div class="form-group">
				<button class="btn btn-primary">Fetch Restaurant</button>
			  </div>
