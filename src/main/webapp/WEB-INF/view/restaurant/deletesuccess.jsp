...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 20px;padding: 150px;height: 300px;">
		<div class="row">
			<div class="alert alert-success">Restaurant Removed Sucessfully</div>
		  </div>
	</div>
	<a href="../../restaurant/listRestaurant"><button class="btn btn-primary" style="margin-left: 10%; margin-bottom: 2%;">Home Page</button></a>
